...
<body>
    ...
    <form method="post" action="exerc5resposta.php">

        <div class="mb-3">
            <label for="nota1" class="form-label">Nota da P1</label>
            <input type="number" id="nota1" name="nota1" class="form-control" required="">
        </div>

        <div class="mb-3">
            <label for="nota2" class="form-label">Nota da P2</label>
            <input type="number" id="nota2" name="nota2" class="form-control" required="">
        </div>

        <div class="mb-3">
            <label for="nota3" class="form-label">Nota da P3</label>
